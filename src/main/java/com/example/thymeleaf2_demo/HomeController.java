...
public class HomeController {
    ...
    public String ngo_listing(Model model, 
        ...
        model.addAttribute("ngos", ngoRepository.findVerifiedNgos(search, city, item));
        model.addAttribute("cities", ngoRepository.findAllCities());
        model.addAttribute("itemTypes", ngoRepository.findAllItemTypes());
